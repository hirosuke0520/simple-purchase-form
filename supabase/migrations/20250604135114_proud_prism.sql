/*
  # Fix Stripe checkout session function

  1. Changes
    - Remove direct Stripe API call from database function
    - Use Edge Function instead for secure API communication
    - Fix HTTP extension schema reference
*/

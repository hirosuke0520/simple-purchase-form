...
-- Create function for checkout session
...
AS $$
BEGIN
    -- This function now delegates to the Edge Function
    -- The actual Stripe API call is handled by the Edge Function
    RETURN json_build_object(
        'checkout_url', format('%s/functions/v1/stripe-checkout?price_id=%s&success_url=%s&cancel_url=%s&mode=%s&customer_email=%s',
